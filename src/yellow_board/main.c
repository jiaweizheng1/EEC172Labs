...
game2:
    ...
    while (1)
    {
        ...
        if (rpstable[0].entry != ' ' && rpstable[1].entry != ' ')
        {
            ...
            drawChar(rpstable[0].x, rpstable[0].y, rpstable[0].entry, RED, BLACK, 4);
...
void rpsbuttons()
{
    if (times_index == 34)
    {
        ...
        case one:
            ...
            {
                rpstable[1].entry = 'R';
                drawChar(rpstable[1].x, rpstable[1].y, 'R', YELLOW, BLACK, 4);
                while (UARTBusy(UARTA1_BASE))
                    ;
                UARTCharPut(UARTA1_BASE, '1');
            }
        ...
        case two:
            ...
            {
                rpstable[1].entry = 'P';
                drawChar(rpstable[1].x, rpstable[1].y, 'P', YELLOW, BLACK, 4);
                while (UARTBusy(UARTA1_BASE))
                    ;
                UARTCharPut(UARTA1_BASE, '2');
            }
        ...
        case three:
            ...
            {
                rpstable[1].entry = 'S';
                drawChar(rpstable[1].x, rpstable[1].y, 'S', YELLOW, BLACK, 4);
                while (UARTBusy(UARTA1_BASE))
                    ;
                UARTCharPut(UARTA1_BASE, '3');
            }
